...
const pins = [
  ...
  { top: '62%', left: '62%', color: 'var(--ink-2)',     glow: 'var(--border)',           label: 'Vercel'     },
  { top: '72%', left: '74%', color: 'var(--ink-2)',     glow: 'var(--border)',           label: 'GitHub'     },
  ...
  return (
    <>
      <svg viewBox="0 0 440 440" fill="none" className="w-full h-full">
        <circle cx="220" cy="220" r="200" stroke="var(--border)" strokeWidth="1" strokeDasharray="3 4"/>
        <circle cx="220" cy="220" r="150" stroke="var(--border)" strokeWidth="1"/>
        <circle cx="220" cy="220" r="100" stroke="var(--border)" strokeWidth="1"/>
        <circle cx="220" cy="220" r="50"  stroke="var(--border)" strokeWidth="1"/>
        <line x1="20"  y1="220" x2="420" y2="220" stroke="var(--border)" strokeDasharray="2 4"/>
        <line x1="220" y1="20"  x2="220" y2="420" stroke="var(--border)" strokeDasharray="2 4"/>
        <text x="220" y="14"  textAnchor="middle" fontFamily="JetBrains Mono" fontSize="10" fontWeight="700" fill="var(--ink-3)" letterSpacing="0.1em">FRONT</text>
        <text x="220" y="434" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="10" fontWeight="700" fill="var(--ink-3)" letterSpacing="0.1em">DESIGN</text>
        <text x="14"  y="224" textAnchor="start"  fontFamily="JetBrains Mono" fontSize="10" fontWeight="700" fill="var(--ink-3)" letterSpacing="0.1em">BACK</text>
        <text x="426" y="224" textAnchor="end"    fontFamily="JetBrains Mono" fontSize="10" fontWeight="700" fill="var(--ink-3)" letterSpacing="0.1em">OPS</text>
        {/* Ring labels */}
        <text x="226" y="48"  fontFamily="JetBrains Mono" fontSize="8" fill="var(--ink-4)">adopt</text>
        <text x="226" y="98"  fontFamily="JetBrains Mono" fontSize="8" fill="var(--ink-4)">trial</text>
        <text x="226" y="148" fontFamily="JetBrains Mono" fontSize="8" fill="var(--ink-4)">assess</text>
        <text x="226" y="198" fontFamily="JetBrains Mono" fontSize="8" fill="var(--ink-4)">hold</text>
        {/* Core */}
        <circle cx="220" cy="220" r="12" fill="var(--green-mid)"/>
